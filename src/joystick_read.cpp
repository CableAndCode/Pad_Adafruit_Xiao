...
// Constructor initializes offset and inversion settings
...
// Update the offset values for X and Y axes
void JoystickReader::setOffset(int offset_x, int offset_y) {
    offsetX = offset_x;
    offsetY = offset_y;
}   

// Process and normalize X-axis raw value
...
// Process and normalize Y-axis raw value
